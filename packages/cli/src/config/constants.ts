...
export const ENV_GEMINI_CLI_SYSTEM_SETTINGS_PATH = 'GEMINI_CLI_SYSTEM_SETTINGS_PATH';
...
export const SYSTEM_SETTINGS_PATH_DARWIN = '/Library/Application Support/GeminiCli/settings.json';
export const SYSTEM_SETTINGS_PATH_WIN32 = 'C:\\ProgramData\\gemini-cli\\settings.json';
...
export const ERROR_GEMINI_API_KEY_NOT_FOUND = 'GEMINI_API_KEY environment variable not found. Add that to your environment and try again (no reload needed if using .env)!';
...
export const ERROR_SAVING_TRUSTED_FOLDERS = 'Error saving trusted folders file:';

// Error messages for sandbox configuration
export const ERROR_INVALID_SANDBOX_COMMAND = (command: string, validCommands: readonly string[]) =>
...
export const ERROR_INVALID_CONFIGURATION = 'Invalid configuration detected. Please check your settings.';
...
export const ERROR_SETTINGS_MERGE_FAILED = 'Failed to merge settings from different scopes.';
