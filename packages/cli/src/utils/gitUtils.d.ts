 ...
 */
export declare const isGitHubRepository: () => Promise<boolean>;
/**
 ...
 */
export declare const getGitRepoRoot: () => Promise<string>;
/**
 ...
 * @throws error if the exec command fails.
 */
export declare function getGitHubRepoInfo(): Promise<{
    owner: string;
    repo: string;
}>;
