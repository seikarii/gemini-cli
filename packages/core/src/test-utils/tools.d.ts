 ...
 */
import { BaseDeclarativeTool, BaseToolInvocation, ToolCallConfirmationDetails, ToolInvocation, ToolResult } from '../tools/tools.js';
import { ModifiableDeclarativeTool, ModifyContext } from '../tools/modifiable-tool.js';
/**
