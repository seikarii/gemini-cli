...
describe('ToolSelectionGuidance', () => {
  it('should recommend AST tools for code file modifications', () => {
    const userMessage = 'Update the handleSubmit function in src/components/Form.tsx';
    const conversationHistory: Content[] = [
      ...
      {
        role: 'model', 
        parts: [{ text: 'Sure, I can help with React component modifications.' }]
      }
    ];

    const guidance = ToolSelectionGuidance.generateGuidance(userMessage, conversationHistory);
  ...
  it('should recommend write_file for new file creation', () => {
    const userMessage = 'Create a new UserService.ts file with basic CRUD operations';
    const conversationHistory: Content[] = [];
  ...
  it('should handle complex scenarios with multiple file types', () => {
    const userMessage = 'Update both config.json and UserService.ts to add new validation';
    const conversationHistory: Content[] = [];
  ...
  it('should extract file references from quoted strings', () => {
    const userMessage = 'Please modify "src/utils/helper.js" and `config/settings.yml`';
    const conversationHistory: Content[] = [];
  ...
  it('should provide usage guidance for different operation types', () => {
    const userMessage = 'Analyze the performance issues in the database connection code';
    const conversationHistory: Content[] = [];
  ...
  it('should include warnings for potentially problematic scenarios', () => {
    const userMessage = 'Change all variable names in the entire codebase from oldName to newName';
    const conversationHistory: Content[] = [];
