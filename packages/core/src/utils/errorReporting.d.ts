 ...
 */
export declare function reportError(error: Error | unknown, baseMessage: string, context?: Content[] | Record<string, unknown> | unknown[], type?: string, reportingDir?: string, // for testing
fileSystemService?: FileSystemService): Promise<void>;
