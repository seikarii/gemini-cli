 ...
 */
export declare function partToString(value: PartListUnion | undefined | null, options?: {
    verbose?: boolean;
}): string;
export declare function getResponseText(response: GenerateContentResponse): string | null;
export { getFunctionCalls, getFunctionCallsAsJson, getStructuredResponse, } from './generateContentResponseUtilities.js';
